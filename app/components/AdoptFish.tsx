    ...
    <div className="space-y-6 p-4 max-w-md mx-auto">
      ...
      <div className="bg-green-50 border border-green-200 rounded-lg p-3 text-center">
        <div className="text-sm font-medium text-green-800 mb-1">
          🧪 Testnet Mode - Super Low Fees!
        </div>
        <div className="text-xs text-green-700">
          All fish cost less than 0.00001 ETH - Perfect for testing with 0.0001 ETH!
        </div>
      </div>
          ...
          <div className={`${getRarityColor(generatedFish.rarity)} border-2 rounded-xl p-6 text-center shadow-lg`}>
            ...
            <div className="bg-white bg-opacity-75 rounded-lg p-3 mb-4">
              ...
              <div className="text-xs text-gray-600 mt-1">
                💰 Super affordable testnet pricing!
              </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <div className="grid grid-cols-2 gap-2 text-xs text-blue-700">
          <div>🥉 Bronze: 0.000001 ETH</div>
          <div>🥈 Silver: 0.000002 ETH</div>
          <div>🥇 Gold: 0.000005 ETH</div>
          <div>💎 Diamond: 0.00001 ETH</div>
        </div>
        <div className="text-xs text-blue-600 mt-2 text-center">
          Your Balance: 0.0001 ETH - You can adopt ~10 Diamond fish! 🐟
        </div>
      </div>
